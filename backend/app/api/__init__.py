...
from app.api import auth, health, predict, train, upload
...
def build_api_router() -> APIRouter:
    ...
    Returns:
        fastapi.APIRouter: Router aggregating the auth, upload, train and predict
        routes.
    """
...
__all__ = ["build_api_router", "auth", "health", "predict", "train", "upload"]
