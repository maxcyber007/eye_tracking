    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950">
      ...
      <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/90 backdrop-blur dark:border-slate-800 dark:bg-slate-900/90">
        <div className="mx-auto flex max-w-3xl items-center gap-3 px-4 py-3 sm:px-6">
          {/* The brand doubles as the way back out of the flow. */}
          <Link
            href="/"
            aria-label="กลับไปหน้าแรก"
            className="flex min-w-0 flex-1 items-center gap-3 rounded-lg outline-none transition-opacity hover:opacity-80 focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-slate-900"
          >
            <span
